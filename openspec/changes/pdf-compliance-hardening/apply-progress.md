...
- Hygiene: zero `wompi` matches (case-insensitive) anywhere under `apps/mobile`; zero hardcoded secret-shaped strings; zero PAN/CVC values in console output.
